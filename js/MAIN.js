// WEB ADDRESS: http://whitevinyldesign.com/code_explore_create/
// CANVAS //
var canvas;
var ctx;
...
function init() {
    ...
    // generateOrganism1(9,0,0, width, height);
...
function generateVisual(position, size, color) {
    visuals.push( new Visual(position.x, position.y, size * 2, color) );
}
